...
public class Interfaz2 extends javax.swing.JFrame {
    ...
    public void initComponents() {
        ...
        jButton4.setBounds(16, 38, 79, 23);
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE)))
    ...
    public void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(ya){
        String raiz = "raiz [ ";
        for(int i = 0; i < raiz1.primerNodo.Personas.length && raiz1.primerNodo.Personas[i] != 0; i++){
            raiz += raiz1.primerNodo.Personas[i] + ", ";
        }
        raiz += " ]\n";
    ...
    public javax.swing.JFrame frameArbol;
